...
a persistence unit "group3PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "group3\pom.xml":
...
artifact ("group3.war") is already built. You can build

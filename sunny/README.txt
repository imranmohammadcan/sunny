...
a persistence unit "sunnyPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "sunny\pom.xml":
...
artifact ("sunny.war") is already built. You can build
